...
submitButton1.onclick = () => {
  ...
  if (numberInput1 < 0 && numberInput1 > 100) {
    ...
    message1 = 'You know some thing. Needs improvement.';
  } else if (numberInput1 >= 40 && numberInput1 <= 60) {
  ...
  } else if (numberInput1 >= 90) {
    message1 = 'what a amazing score!';
  }
...
submitButton2.onclick = () => {
  ...
  } else if (numberInput2 >= 0 && numberInput2 <= 19) {
    message2 = 'That was a terrible score!';
  } else if (numberInput2 >= 20 && numberInput2 <= 39) {
    message2 = 'You know some thing. Needs improvement.';
  } else if (numberInput2 >= 40 && numberInput2 <= 60) {
    message2 = 'You did a passable job, not bad!';
  } else if (numberInput2 >= 70 && numberInput2 <= 89) {
    message2 = "That's a great score. You really know your stuff";
  } else if (numberInput2 >= 90 && numberInput2 <= 100) {
    message2 = 'what a amazing score!';
  }
